--[=[
	...
	apply proper optimizations. The main performance cost of doing this comes down to tracking and upating 
	the position of the objects, which is fine if: 
		1) You have a way to detect the movement without having to loop through all the moving objects to 
		update the position
		2) You can tolerate some inaccuracy with positions and smear this update
		3) You have less than 1000 objects to track, in this case looping through everything shouldn't be too 
		costly. 
	:::
